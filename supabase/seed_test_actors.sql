-- ====================================================================
-- 10 TEST ACCOUNTS: Hollywood Golden Age Actors
-- 1@test.com ... 10@test.com — password: "password" for all
-- Display names: Golden Age Hollywood actors
-- ====================================================================
...
begin
  ...
  for i in 1..10 loop
    ...
    if v_user_id is null then
      ...
      -- Update password, reset display name, and clear nulls
      update auth.users
    ...
    -- Upsert public profile with actor display name
    insert into public.profiles (id, display_name)
    values (v_user_id, v_display_name)
    on conflict (id) do update set display_name = excluded.display_name;

    -- Link to PHC-DEMO facility
    ...
    raise notice 'Upserted test account % → % (display_name: %)', i, v_email, v_display_name;
  end loop;

  raise notice 'Done — 10 test accounts ready (1@test.com through 10@test.com)';
end $$;
